...
```{r, message=FALSE}
# Import the Rhats
rhats <- fread('../output/LFXC/ae_only/Model2/Model2_RHat.csv',header = T)
...
```{r, message=FALSE}
traces <- read.csv('../output/LFXC/ae_only/Model2/Model2_traces.csv')
...
df.ppc <- read.csv('../output/LFXC/ae_only/Model2/Model2_simData.csv') %>%
