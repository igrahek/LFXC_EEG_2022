...
model = readRDS("model.model.reward_probability_EffLvl.rds")
```
...
# Set the working directory in order to load the models
setwd(here("Analyses/Experiment2/Stats/brms/Cluster/output"))
model = readRDS("model.model.reward_probability_Effmbased.rds")
```
...
# Set the working directory in order to load the models
setwd(here("Analyses/Experiment2/Stats/brms/Cluster/output"))
model = readRDS("model.model.Rewmbased_Effmbased.rds")
```
...
pdf(file="C:/Users/igrahek/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/LFXC_EEG/Manuscript/plots/Figures/Exp2/Figure5A_New.pdf")
...
p = p +  scale_y_discrete(labels= c(
  ...
  labs(x = "Regression estimate", y = "Feedback\n") + 
  scale_x_continuous(limits = c(-0.05,0.25),breaks=seq(-0.05, 0.25, by = 0.05)) + 
...
pdf(file="C:/Users/igrahek/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/LFXC_EEG/Manuscript/plots/Figures/Exp2/FigureS6_New.pdf")
...
pdf(file="C:/Users/igrahek/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/LFXC_EEG/Manuscript/plots/Figures/FigureS4_C.pdf")
p = plot(p,plot=FALSE)[[1]]+
...
pdf(file="C:/Users/igrahek/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/LFXC_EEG/Manuscript/plots/Figures/Exp2/Figure5_d1.pdf",4,7)
...
p = marginal_effects(model, effects = "Congruency",plot=FALSE) 
pdf(file="C:/Users/igrahek/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/LFXC_EEG/Manuscript/plots/Figures/FigureS4_D.pdf")
...
pdf(file="C:/Users/igrahek/Dropbox (Brown)/CLPS-ShenhavLab/EEG_Studies/Experiments/LFXC_EEG/Manuscript/plots/Figures/Exp2/Figure5_D2.pdf",4,7)
